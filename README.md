...
If you complete his chore, Rufus will reward you with a shadow lodestone. Adventuring through a Shadow Rift with that item will give you three possile rewards:

1) forge - access to the Shadow Forge (until you spend an adventure) where you can craft stuff from shadow items.
2) waters - 30 turns of Shadow Waters, which grants +100 to Initiative, Meat Drop, and Item Drop
...
I don't recommend this, since, contrary to what you might have intended, even though you using not-free turns, it limits your liability to 10 turns spent by stopping after the Labyrinth of Shadows.
You can simply repeat the command and try again.
```
Shadowrift check
(Rufus wants 3 shadow flames)
ShadowRift items flame moxie forge notonlyfree
```
...
And perhaps ShadowRiftConsult charms you - in which case you could just use it in your own CCS. But I suspect that people might have other techniques in mind for combats, if they are faring, rather than doing quests.
